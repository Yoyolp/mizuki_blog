...
export const siteConfig: SiteConfig = {
	title: "超级玉米人的博客",
	subtitle: "Ciallo ~",
	siteURL: "https://yoyolp.github.io/", // 请替换为你的站点URL，以斜杠结尾
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到我的博客！这里将分享我的日常与技术学习笔记。~(∠・ω< )⌒★ ", // 公告内容
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		...
		// "https://some-stable-api.com/api?server=:server&type=:type&id=:id",
	id: "14164869977", // 歌单ID
	server: "kugou", // 音乐源服务器。有的meting的api源支持更多平台,一般来说,netease=网易云音乐, tencent=QQ音乐, kugou=酷狗音乐, xiami=虾米音乐, baidu=百度音乐
	type: "playlist", // 播单类型
};
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Ciallo ~ 泥嚎!欢迎来到SuperCornManの博客!", // 欢迎词
		touch: [
			"我的刀盾?",
			"比比拉布!",
			"HENTAI! 八嘎雅鹿!",
